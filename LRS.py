...
if __name__ == "__main__":
    ...
    if task == mnist:
        ...
        # test_dataloader = DataLoader(dataset=val_dataset, batch_size=batch_size, num_workers=0, shuffle=False)
        ...
        for epoch in range(start_epoch, start_epoch + epoches):
            ...
            for batch, [trainX, trainY] in enumerate(tqdm(train_dataloader, ncols=10)):
                ...
                if BP_train:
                    ...
                    net.update_params(learning_rate, BP_train, method='sgd')
            trainLoss /= nbatch
        ...
        net.save_weights('mnist_model/FashionLRS.pkl')
        alg_end = time.time()
    print(np.mean(time_list))
    print('train_loss:{}\n test_loss:{}\n acc:{}'.format(train_loss, test_loss, acc))
    print('time:{}'.format(time_list))
    with open('FashionLRS.pkl', 'wb') as file:
        pkl.dump(
