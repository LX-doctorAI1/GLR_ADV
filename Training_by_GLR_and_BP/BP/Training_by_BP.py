...
if __name__ == '__main__':
    ...
    for epoch in range(1200):
        ...
        for data in tqdm(trainloader):
            ...
            inp_little = inp_little.reshape(num_of_sample_in_batch,196)
        ...
        print('Epoch: {} | Loss: {}'.format(epoch, running_loss / 235.0)) #0.024
    ...
    print("test set Accuracy: {}".format(test_accuracy)) #0.98
    ...
    # with open("weights_acc=" + str(test_accuracy) + "_size=14_protocol=2.pkl", "wb") as f:
    #     import pickle
    ...
    with open("weights_acc=" + str(test_accuracy) + ".pkl", "wb") as f2:
