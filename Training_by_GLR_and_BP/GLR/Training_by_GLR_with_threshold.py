...
print("SDENN minist training : threshold,maxeopch=" + str(max_nb_of_iterations) + ",sigm=" + str(
    sigm) + ",sample_size=14*14")
...
for iteration in range(max_nb_of_iterations):
    ...
    # save the result every ten minitues
    if (nb_of_iterations % 1) == 0:
        ...
        minibatch_x_inds = np.linspace(0, len(training_costs_iteration), num=len(training_costs_iteration))
